...
> 字体在 `src/styles/global.css` 中以 `@font-face` 定义；字体与颜色的全局映射统一在 `src/styles/variables.css` 的 `@theme inline` 块中配置。

---

## 结语

如果你在搭建过程中遇到困难，欢迎在 [GitHub Issues](https://github.com/coderking3/king3.me/issues) 提问，或者在 [king3.me](https://king3.me/) 留言。

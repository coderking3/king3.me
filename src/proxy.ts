...
export const config = {
  matcher: [
    '/((?!api|_next/static|_next/image|favicon\\.ico|icon\\.svg|apple-icon\\.png|opengraph-image\\.png|twitter-image\\.png|fonts|images|feed\\.xml|feed|rss|rss\\.xml|robots\\.txt|sitemap\\.xml|site\\.webmanifest).*)'
  ]
}

    ...
    <header className="sticky top-0 right-0 left-0 z-50 h-16 w-full pt-4">
      <div className="mx-auto h-full max-w-6xl px-6">
        <div className="flex h-full items-center justify-between">
          {/* Menus */}
          <div className="shadow-muted-foreground/10 border-border/70 dark:border-border from-background/70 to-background/90 flex items-center rounded-full border bg-linear-to-b pl-3 shadow-xl backdrop-blur-xs backdrop-saturate-150 dark:shadow-lg">
            {/* Logo */}
            <Logo></Logo>
          ...
          >
            <div
              className={cn(
                'from-background/70 to-background/90 shadow-muted-foreground/10 border-border/70 dark:border-border text-accent-foreground/85 flex h-11.5 w-auto items-center gap-0.5 rounded-full border bg-linear-to-b px-3 shadow-xl backdrop-blur-xs backdrop-saturate-150 transition-all dark:shadow-lg'
              )}
            >
              {/* Search */}
              <Search />

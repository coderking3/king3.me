...
interface PictureIconProps extends Omit<SvgIcon, 'strokeWidth' | 'color'> {}

export function PictureIcon({ size = 20 }: PictureIconProps) {
  return (
    <svg

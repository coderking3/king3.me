...
export const description = `Hi, I'm ${AUTHOR_INFO.name}. A frontend developer, open-source enthusiast, and creative soul.`
    ...
    <div className="mt-16 sm:mt-24">
      <div className="mx-auto max-w-6xl px-4 sm:px-8">
        ...
        <section className="mt-16">
          <Animated preset={{ mode: 'fadeInUp', delay: 0.15 }}>
